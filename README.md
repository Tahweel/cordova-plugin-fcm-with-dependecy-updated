...
Add the following config to iOS project
+ Assign app-group capapility to the project under group ex: group.com.ibm.test1
+ In project and extention plist files add 'group' as string group.com.ibm.test1
